...
<!-- Footer Moderno -->
<footer style="margin-left:300px; background: linear-gradient(135deg, #f5f5f0 0%, #faf8f3 100%); border-top: 3px solid #D4B896; padding: 30px 20px;">
    <div class="w3-row-padding">
        ...
        <div class="w3-col l4 m6 s12" style="margin-bottom: 20px;">
            ...
            <div style="margin-top: 15px;">
                <a href="#" class="w3-button" style="background: #D4B896; color: white; margin-right: 5px; border-radius: 50%; width: 35px; height: 35px; padding: 0;">
                    <i class="fa fa-facebook"></i>
                </a>
                <a href="#" class="w3-button" style="background: #D4B896; color: white; margin-right: 5px; border-radius: 50%; width: 35px; height: 35px; padding: 0;">
                    <i class="fa fa-instagram"></i>
                </a>
                <a href="#" class="w3-button" style="background: #D4B896; color: white; border-radius: 50%; width: 35px; height: 35px; padding: 0;">
        ...
        <div class="w3-col l4 m6 s12" style="margin-bottom: 20px;">
            ...
            <ul style="list-style: none; padding: 0; color: #666; font-size: 14px; line-height: 2;">
                <li><a href="/" style="text-decoration: none; color: #666; transition: color 0.3s;" onmouseover="this.style.color='#B89968'" onmouseout="this.style.color='#666'">
                    <i class="fa fa-angle-right"></i> Dashboard
                </a></li>
                <li><a href="/item/listar" style="text-decoration: none; color: #666; transition: color 0.3s;" onmouseover="this.style.color='#B89968'" onmouseout="this.style.color='#666'">
                    <i class="fa fa-angle-right"></i> Gerenciar Itens
                </a></li>
                <li><a href="/reservas/listar" style="text-decoration: none; color: #666; transition: color 0.3s;" onmouseover="this.style.color='#B89968'" onmouseout="this.style.color='#666'">
                    <i class="fa fa-angle-right"></i> Reservas
                </a></li>
                <li><a href="/vendas/listar" style="text-decoration: none; color: #666; transition: color 0.3s;" onmouseover="this.style.color='#B89968'" onmouseout="this.style.color='#666'">
    ...
    <div class="w3-center" style="color: #999; font-size: 13px;">
        <p style="margin: 5px 0;">
            © 2024 <strong style="color: #8B6F47;">Sebo Alfarrábio</strong> - Todos os direitos reservados
        </p>
        <p style="margin: 5px 0;">
        ...
        <p style="margin: 5px 0; font-size: 11px;">
            Powered by <a href="https://www.w3schools.com/w3css/" target="_blank" style="color: #B89968; text-decoration: none;">W3.CSS</a>
        </p>
    </div>
</footer>
