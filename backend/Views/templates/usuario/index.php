...
<?php if (isset($usuarios) && count($usuarios) > 0): ?>
    <table border="1" cellpadding="5" cellspacing="0" class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
        <thead>
            <tr>
                <th>ID</th><th>Nome</th><th>Email</th><th>Tipo</th><th>Status</th><th>Ações</th>
            </tr>
        </thead>
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo ($usuario['excluido_em'] ? 'Inativo' : 'Ativo'); ?></td>
                    <td>
                        <a href="/backend/usuario/editar/<?php echo $usuario['id_usuario']; ?>" class="w3-button w3-blue w3-small">Editar</a>
                        <a href="/backend/usuario/excluir/<?php echo $usuario['id_usuario']; ?>" class="w3-button w3-red w3-small" onclick="return confirm('Desativar?');">Excluir</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
