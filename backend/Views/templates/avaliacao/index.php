...
<style>
    ...
    [data-theme="dark"] .avaliacao-wrapper {
        background: linear-gradient(135deg, #1a1209 0%, #221a10 100%);
        color: #f5f1e8;
    }

    [data-theme="dark"] .container-avaliacoes {
        background: #221a10;
        box-shadow: 0 6px 20px rgba(0, 0, 0, 0.3);
    }

    [data-theme="dark"] .header-avaliacoes {
    ...
    [data-theme="dark"] .table-avaliacoes {
        background: #221a10;
    }

    [data-theme="dark"] .table-avaliacoes thead {
        background: linear-gradient(135deg, #33261a 0%, #2a1f14 100%);
    }

    [data-theme="dark"] .table-avaliacoes tbody tr:hover {
        background: #33261a;
    }

    [data-theme="dark"] .table-avaliacoes tbody tr {
        border-bottom-color: rgba(212, 165, 116, 0.1);
    }

    [data-theme="dark"] .comentario-cell,
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="comentario-cell"
                                            title="<?= htmlspecialchars($av['comentario_avaliacao']) ?>">
                                            <?php if (!empty($av['comentario_avaliacao'])): ?>
                                                <i class="fas fa-quote-left"
                                                    style="color: var(--bege-dark); font-size: 0.8rem;"></i>
                                                <?= htmlspecialchars($av['comentario_avaliacao']) ?>
                                            <?php else: ?>
                                                <span style="color: #999; font-style: italic;">Sem comentário</span>
                                            <?php endif; ?>
                                    ...
                                    <td>
                                        <div class="actions-cell">
                                            <a href="/backend/avaliacao/editar/<?= $av['id_avaliacao'] ?>"
                                            ...
                                            <?php if ($av['status_avaliacao'] == 'ativo'): ?>
                                                <a href="/backend/avaliacao/deletar/<?= $av['id_avaliacao'] ?>"
