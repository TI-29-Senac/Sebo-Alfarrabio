...
<style>
    ...
    [data-theme="dark"] .modern-table thead th {
        background: linear-gradient(135deg, #3d2e20, #33261a);
    }
    ...
    [data-theme="dark"] .pending-notification {
        background: linear-gradient(135deg, #5a2020 0%, #4a1818 100%);
        box-shadow: 0 4px 15px rgba(90, 32, 32, 0.4);
    }

    [data-theme="dark"] .btn-view-pending {
        background: rgba(255, 255, 255, 0.15);
        color: #ffb3b3;
    }

    [data-theme="dark"] .btn-view-pending:hover {
        background: rgba(255, 255, 255, 0.25);
    }

    /* ========================================
       RESPONSIVO — ADMIN DASHBOARD
       ======================================== */
