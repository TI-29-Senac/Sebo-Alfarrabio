...
<head>
    ...
    <style>
        ...
        [data-theme="dark"] .sidebar-sebo .user-email {
            color: #d4c5a9;
        }
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-col s9" style="padding-left: 15px;">
                        ...
                        <div style="margin-top: 12px;">
                            ...
                            <a href="/backend/admin/cliente/notificacoes" class="user-action-btn w3-button"
                                title="Mensagens">
