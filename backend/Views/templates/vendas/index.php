...
.stat-card.brown { border-left-color: var(--marrom); }
...
.stat-card.brown .stat-icon { background: linear-gradient(135deg, var(--marrom), #6B5235); }
.stat-card.red .stat-icon { background: linear-gradient(135deg, #dc3545, #c82333); }
.stat-card.green .stat-icon { background: linear-gradient(135deg, var(--verde), #557016); }
.stat-card.blue .stat-icon { background: linear-gradient(135deg, var(--azul), #4A7FB8); }
...
<div class="vendas-container">
    ...
    <div class="vendas-header">
        ...
        <a href="/vendas/criar" class="btn-nova-venda">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="/vendas/editar/<?= $venda['id_venda'] ?>" 
                                           class="btn-action btn-edit" 
                                           title="Editar">
                                            <i class="fa fa-edit"></i> Editar
                                        </a>
                                        <a href="/vendas/excluir/<?= $venda['id_venda'] ?>" 
                ...
                <div class="pagination-container">
                    <div class="pagination">
                        <?php if ($paginacao['pagina_atual'] > 1): ?>
                            <a href="/vendas/listar/1" class="page-btn" title="Primeira página">
                                <i class="fa fa-angle-double-left"></i>
                            </a>
                            <a href="/vendas/listar/<?= $paginacao['pagina_atual'] - 1 ?>" class="page-btn" title="Página anterior">
                        ...
                        for ($i = $inicio; $i <= $fim; $i++): ?>
                            ...
                            <?php else: ?>
                                <a href="/vendas/listar/<?= $i ?>" class="page-btn"><?= $i ?></a>
                            <?php endif; ?>
                        <?php endfor; ?>

                        <?php if ($paginacao['pagina_atual'] < $paginacao['ultima_pagina']): ?>
                            <a href="/vendas/listar/<?= $paginacao['pagina_atual'] + 1 ?>" class="page-btn" title="Próxima página">
                                <i class="fa fa-angle-right"></i>
                            </a>
                            <a href="/vendas/listar/<?= $paginacao['ultima_pagina'] ?>" class="page-btn" title="Última página">
                                <i class="fa fa-angle-double-right"></i>
                            </a>
                        <?php endif; ?>
                    </div>
                    <p class="pagination-info">
                        Mostrando <strong><?= $paginacao['de'] ?></strong> a <strong><?= $paginacao['para'] ?></strong> de <strong><?= $paginacao['total'] ?></strong> registros
                    </p>
                </div>
            <?php endif; ?>
        </div>
    ...
    <?php else: ?>
        ...
        <div class="empty-state">
            ...
            <a href="/vendas/criar" class="btn-primary">
                <i class="fa fa-plus-circle"></i>
