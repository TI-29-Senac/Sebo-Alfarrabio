...
class APIPedidosController
{
    ...
    public function salvarPedidos()
    {
        ...
        // Tenta pegar usuário da sessão ou token (se implementado)
        ...
        // Chama o método correto do Model que processa o carrinho
        // O método criarPedido($itensCarrinho) já faz a inserção do pedido e dos itens
        $novoPedidoId = $this->pedidosModel->criarPedido($pedidos);
        if ($novoPedidoId) {
