function finalizarReservas() {
    if (carrinho.length === 0) {
        reservasStatusEl.textContent = 'Seu carrinho está vazio.';
        return;
    }
    reservasStatusEl.textContent = 'Enviando reservas...';

    fetch('/backend/api/reservas', {
        method: 'POST',
